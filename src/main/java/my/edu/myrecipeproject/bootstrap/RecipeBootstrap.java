...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        UnitOfMeasure uomEach = new UnitOfMeasure();
        uomEach.setDescription("Each");
        unitOfMeasureRepository.save(uomEach);

        UnitOfMeasure uomDash = new UnitOfMeasure();
        uomDash.setDescription("Dash");
        unitOfMeasureRepository.save(uomDash);
